...
batch_meshes_path = os.path.expanduser(
    '~/catkin_ws/src/stretch_ros/stretch_robotiq_description/batch/' + batch_name) + '/meshes/*.STL'
batch_urdfs_path = os.path.expanduser('~/catkin_ws/src/stretch_ros/stretch_robotiq_description/batch/' + batch_name) + '/urdf/*.xacro'

meshes_path = os.path.expanduser('~/catkin_ws/src/stretch_ros/stretch_robotiq_description/meshes')
urdfs_path = os.path.expanduser('~/catkin_ws/src/stretch_ros/stretch_robotiq_description/urdf')
